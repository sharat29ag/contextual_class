...
class Cityscapes_active_loader(BaseDataset):
    ...
    def __init__(
        ...
        self.active_list_path = cfg['active_list_path']
        self.img_ids = [i_id.strip() for i_id in open(self.active_list_path)]
        ...
        # self.files = recursive_glob(rootdir=self.images_base, suffix=".png") #find all files from rootdir and
        # subfolders with suffix = ".png"
        self.files = [os.path.join(self.images_base, i_id) for i_id in self.img_ids]
        if cfg.get('shuffle'):
